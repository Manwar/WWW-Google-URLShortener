...
$WWW::Google::URLShortener::Analytics::Result::Referrer::VERSION = '0.16';

=head1 NAME

WWW::Google::URLShortener::Analytics::Result::Referrer - Placeholder for the result referrer of analytics.
...
Returns the id of the result referrer.

=head2 count()

Returns the count of the result referrer.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::Google::URLShortener::Analytics::Result::Referrer
...
1; # End of WWW::Google::URLShortener::Analytics::Result::Referrer
