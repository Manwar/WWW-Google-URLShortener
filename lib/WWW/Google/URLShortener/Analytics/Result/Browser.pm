package WWW::Google::URLShortener::Analytics::Result::Browser;

$WWW::Google::URLShortener::Analytics::Result::Browser::VERSION   = '0.20';
$WWW::Google::URLShortener::Analytics::Result::Browser::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

WWW::Google::URLShortener::Analytics::Result::Browser - Placeholder for the result browser of analytics.
...
Returns the id of the result browser.

=head2 count()

Returns the count of the result browser.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::Google::URLShortener::Analytics::Result::Browser
...
1; # End of WWW::Google::URLShortener::Analytics::Result::Browser
