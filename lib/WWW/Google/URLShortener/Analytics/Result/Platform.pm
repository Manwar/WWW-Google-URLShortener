...
$WWW::Google::URLShortener::Analytics::Result::Platform::VERSION = '0.15';

=head1 NAME

WWW::Google::URLShortener::Analytics::Result::Platform - Placeholder for the result platform of analytics.
...
Returns the id of the result platform.

=head2 count()

Returns the count of the result platform.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::Google::URLShortener::Analytics::Result::Platform
...
1; # End of WWW::Google::URLShortener::Analytics::Result::Platform
