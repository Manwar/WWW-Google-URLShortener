...
$WWW::Google::URLShortener::Analytics::Result::Country::VERSION   = '0.20';
$WWW::Google::URLShortener::Analytics::Result::Country::AUTHORITY = 'cpan:MANWAR';

=head1 NAME

WWW::Google::URLShortener::Analytics::Result::Country - Placeholder for the result country of analytics.
...
Returns the id of the result country.

=head2 count()

Returns the count of the result country.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WWW::Google::URLShortener::Analytics::Result::Country
...
1; # End of WWW::Google::URLShortener::Analytics::Result::Country
